...
let tamanhoFonte = 16; // Tamanho inicial da fonte (padrão)

function aumentarFonte() {
    tamanhoFonte += 2; // Aumenta a fonte em 2px
    document.body.style.fontSize = tamanhoFonte + 'px'; // Aplica a mudança no corpo da página
}

function diminuirFonte() {
    if (tamanhoFonte > 10) { // Impede que a fonte fique muito pequena
        tamanhoFonte -= 2; // Diminui a fonte em 2px
